  ...
  return (
    <div className="About">
      ...
      <p className="aboutText">
        Este site é um projeto individual, criado por Marcos Douglas, estudante
        da EREM Padre Guedes, e tem como objetivo ajudar os participantes do
        Sistema Seriado de Avaliação (SSA) a descobrir a nota necessária para
